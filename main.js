...
(function() {
  var G, Planet, Vector2, update, clear, clicksRaw, combinedInput, draw, fps, framerate, init, planets, reset, resize, scale, simspeed, sizeCanvas, tick, totalGravityVector;
  ...
  update = function(p, arr) {
    ...
    p.X -= (p.V.X / framerate) * simspeed;
    return p.Y -= (p.V.Y / framerate) * simspeed;
  };
